...
EXISTING, unmodified print-prep pipeline in trellis_core/printable.py
...
trellis_core/printable.py's repair_watertight() already documents as
...
def run_generation_with_dpo(
    ...
    *,
    ...
    try:
        ...
        # patches/mps_compat.py's patch_mesh_base() has already turned into an
