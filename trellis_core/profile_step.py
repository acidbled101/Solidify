...
def main() -> int:
    ...
    from .sft_train import split_dataset, flow_matching_loss
    from .flow_dpo_objective import FlowDPOConfig
    ...
    cfg = FlowDPOConfig(sigma_min=1e-5, t_sampling="uniform", t_max=1.0)
