# Apple Silicon port — original documentation
...
thermal throttling are still accurate and still useful.

Paths in the text below refer to the layout of the original repository, where
`backends/` and `patches/` sat at the top level. In this repository they are
under `third_party/`. See [`../THIRD_PARTY.md`](../THIRD_PARTY.md) for what
