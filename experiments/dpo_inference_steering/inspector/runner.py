...
Runs as a SUBPROCESS (see experiments/dpo_inference_steering/inspector/server.py), not a thread, because the DPO
...
from experiments.dpo_inference_steering.inspector.trace import TraceWriter  # noqa: E402
