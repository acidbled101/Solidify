...
Companion to experiments/dpo_inference_steering/inspector/alignment_experiment.py, which trains a 33.8K-parameter
...
Run:  python experiments/dpo_inference_steering/inspector/real_mechanism.py --print
"""
...
from experiments.dpo_inference_steering.inspector import metrics
...
def build(traces_dir: Path = TRACES_DIR) -> dict:
    ...
    return {
        "meta": {
            "generated_by": "experiments/dpo_inference_steering/inspector/real_mechanism.py",
            ...
            "note": (
                ...
                "actual TRELLIS.2-4B generations (experiments/dpo_inference_steering/inspector/runner.py). No synthetic shape, "
