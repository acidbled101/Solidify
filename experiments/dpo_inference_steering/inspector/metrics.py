...
experiments/dpo_inference_steering/inspector/traces/:
...
Run:  python experiments/dpo_inference_steering/inspector/metrics.py            (writes the three files)
      python experiments/dpo_inference_steering/inspector/metrics.py --print    (also dumps a summary table)
"""
...
def build(traces_dir: Path = TRACES_DIR) -> dict:
    ...
    # SYNTHETIC RUNS ARE EXCLUDED. experiments/dpo_inference_steering/inspector/traces/synthetic-demo exists to
