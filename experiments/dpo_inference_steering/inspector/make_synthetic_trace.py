...
Run: python experiments/dpo_inference_steering/inspector/make_synthetic_trace.py
"""
import os
import sys
...
from experiments.dpo_inference_steering.inspector.trace import TraceWriter
from experiments.dpo_inference_steering import geometric_judge as gj
from experiments.dpo_inference_steering.dpo_branch import DPOBranchConfig, build_t_pairs, select_branch_windows
...
def main():
    ...
    # exports glb+obj (no stl), matching experiments/dpo_inference_steering/inspector/runner.py's --vanilla-too path.
