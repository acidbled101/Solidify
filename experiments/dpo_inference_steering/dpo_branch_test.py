"""
CPU-only, plain-torch unit tests for experiments/dpo_inference_steering/dpo_branch.py.
...
self-contained script: plain `assert`s plus a __main__ runner.
    ...
    python experiments/dpo_inference_steering/dpo_branch_test.py
...
# Runnable as `python experiments/dpo_inference_steering/dpo_branch_test.py` from the repo root or
...
def test_latent_probe_is_deterministic_and_cannot_fake_separation():
    ...
    """
    from .dpo_branch import LatentProbe
...
def test_score_detailed_degrades_like_rank():
    ...
    """
    import numpy as np
    from evaluation import geometric_judge as gj
