...
# bootstrap puts third_party/ on sys.path, which is where the upstream
# backends package now lives -- this test imports mesh_extract directly.
from trellis_core import bootstrap  # noqa: F401
from evaluation import geometric_judge as gj
from . import printability_proxy as pp
...
def test_gradient_flows_through_extraction():
    ...
    Runs third_party/backends/mesh_extract.py's flexible_dual_grid_to_mesh -- the exact
