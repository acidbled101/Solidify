...
module.
    ...
    third_party/backends/mesh_extract.py::flexible_dual_grid_to_mesh, line 117:
...
MEASURED (66 real decoded candidate meshes from experiments/dpo_inference_steering/inspector/traces, 23 distinct
