...
experiments/dpo_inference_steering/dpo_branch.py's steer_delta).
...
class LinearPath:
    ...
    build_t_pairs in experiments/dpo_inference_steering/dpo_branch.py), which is why this is the
...
def dpo_loss_reference_free(
    ...
    *,
    ...
    ~9.5 GB (see checkpointed_blocks in experiments/dpo_inference_steering/dpo_branch.py, and the
